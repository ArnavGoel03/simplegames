...
## 20 September 2026: game-history visual harness prepared
...
the local fixture timing limitation below, not a certified green gate. The
existing visual workflow reruns the complete gate on Linux before browsers.
No timing limits were widened. See [the fixture receipt](PLAYER-HISTORY-FIXTURE-2026-09-20.md).
