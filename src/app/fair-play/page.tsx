...
export default function FairPlayPage() {
  return (
    <>
      {/* Where this page sits, for the trail a result carries under its
          title. Built from the studio's own URL, so it cannot point at
          where a page used to be. */}
      <JsonLd data={breadcrumbs([{ name: "Fair play", path: "/fair-play" }])} />
